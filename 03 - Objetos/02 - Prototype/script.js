...
const jonathan = new Pessoa('Jonathan', 22);

console.log(Pessoa.prototype); // retorna o objeto
console.log(jonathan.prototype); // undefined
...
const pessoa = new Pessoa('Jonathan', 22);
...
const listaArray = Array.prototype.slice.call(lista); // Existe o método Array.from()
