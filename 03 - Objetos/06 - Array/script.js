...
const carros = {
  ...
  1: 'Honda',
  2: 'Ford',
  // Para transformar um objeto em Array é preciso definir seu tamanho(length)
  length: 4,
};
...
// Os próximos métodos são métodos modificadores (mutator methods). Além de retornarem um valor, eles modificam a array original.
...
// ---------------MÉTODOS DE ACESSO---------------
// Os métodos de acesso não modificam a array original, apenas retornam uma array modificada.
